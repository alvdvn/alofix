...
class RowTitleValueWidget extends StatelessWidget {
  const RowTitleValueWidget(
      {Key? key, required this.title, required this.value, this.isShowInvalid})
      : super(key: key);
  final String title;
  final String value;
    ...
    return Row(
      ...
      children: [
        ...
        Row(
          children: [
            Text(value,
                style: FontFamily.normal(size: 14, color: AppColor.colorRedMain)),
            const SizedBox(width: 4),
            Image.asset(Assets.imagesCallLogInvalid, width: 13, height: 13),
            const SizedBox(width: 16)
        ...
        Row(
          children: [
            Text(value,
                style: FontFamily.normal(size: 14, color: AppColor.colorRedMain)),
            const SizedBox(width: 4),
            SvgPicture.asset(Assets.imagesCallLogValid, width: 12, height: 12),
            const SizedBox(width: 16)
