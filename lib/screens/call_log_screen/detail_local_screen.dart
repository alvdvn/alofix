...
class CallLogDetailLocalScreen extends StatefulWidget {
  const CallLogDetailLocalScreen({Key? key}) : super(key: key);

  @override
  State<CallLogDetailLocalScreen> createState() => _CallLogDetailScreenState();
}

class _CallLogDetailScreenState extends State<CallLogDetailLocalScreen> {
